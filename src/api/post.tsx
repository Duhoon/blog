...
export async function getPostDetailedFromCloud(directory:string, filename: string){
...
export async function getPostListFromCloud(directory?: string): Promise<PostList[]> {
